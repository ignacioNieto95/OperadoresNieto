...
function remanenteCantidadProductos(){
    ...
    productosAlmacenados !== 0 && (document.querySelector("#carrito span").textContent = productosAlmacenados);
...
function calcularPrecioTotal(producto){
    ...
    precioAcumulado == null ? localStorage.setItem("precioTotal", producto.precio) : localStorage.setItem("precioTotal", precioAcumulado + producto.precio);
...
//function borrarElemento(productos, botones){
